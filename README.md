...
> *There was a murder last night. Eight suspects, one victim, a floor plan full of clues — and only one arrangement that truly adds up. Grab your magnifying glass.*
...
<p align="center">
  <img src="screenshots/Murdoku_menu.png" width="32%" alt="Start screen with title, Open Case, Tutorial, Editor and level generator" />
  <img src="screenshots/Murdoku_level.png" width="32%" alt="The Files – case selection with preview cards, filters by difficulty and size" />
  <img src="screenshots/Murdoku.png" width="32%" alt="A case in progress: suspects, clues, furniture and crossed-out rows/columns" />
</p>

<p align="center"><sub>Main menu · "The Files" (case selection) · An investigation in full swing</sub></p>
...
- **An automatic level generator** that rolls *endless*, guaranteed-unique cases from 10+ themed settings in three difficulties — running in a Web Worker so the UI never stutters.
...
- **A library of 24 hand-tuned bundled cases** across every difficulty and board size (4×4 up to 16×16) — and the generator adds as many more as you like.
- **Fully bilingual** — English & German, switchable at any time, with every clue written out as a natural sentence.
- **A beautiful, hand-drawn crime scene** on Canvas — plush armchairs, bookshelves, beds, cars and tables that merge into larger pieces.
...
Stuck? There's a **hint giver** that explains the next logical step in words — it never hands you the answer, just a nudge in the right direction.
...
- **Endless new cases** — the built-in **generator** rolls uniquely-solvable levels from 10+ themes (apartment, mansion, hotel, hospital, museum, auto shop …) in three difficulty levels. It runs in a **Web Worker** so the interface stays smooth.
...
src/
  ...
  game/          Engine <-> UI bridge: board rendering, furniture art, sessions, storage
  components/    React building blocks (board, file, toolbar, editor …)
